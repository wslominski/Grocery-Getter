...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: nc62oA4st8Y2M/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: x2DOIjmS3ay72/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: hQx8sr7LHy80I/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__vtVuO)}
          role={"img"}
        />
      }
      navMenuItems={[
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <ph.DataCtxReader>
            {$ctx =>
              true ? (
                <div className={classNames(projectcss.all, sty.freeBox__bf1R7)}>
                  <IconIcon
                    className={classNames(projectcss.all, sty.svg__whrS1)}
                    role={"img"}
                  />
                </div>
              ) : null
      ...
      >
        <ph.DataCtxReader>
          {$ctx =>
            true ? (
              <div className={classNames(projectcss.all, sty.freeBox__lcld6)}>
                {p.renderPlasmicSlot({
                  defaultContents: (
                    <section
                      className={classNames(projectcss.all, sty.section__arU9Q)}
                    >
                      <h1
                        className={classNames(
                          projectcss.all,
